document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      } else if (field.minLength && field.minLength > 0 && value.length > 0 && value.length < field.minLength) {
        error = getFieldLabel(field, form) + ' must be at least ' + field.minLength + ' characters.';
      } else if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
        error = getFieldLabel(field, form) + ' must not exceed ' + field.maxLength + ' characters.';
      }
  ...
  document.body.addEventListener('blur', function (e) {
    ...
    const existingError = field.parentElement && field.parentElement.querySelector('.field-error-message');
    ...
    if (field.hasAttribute('required') && value === '') {
      showFieldError(field, getFieldLabel(field, form) + ' is required.');
    } else if (field.type === 'email' && value !== '') {
      const emailPattern = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
      if (!emailPattern.test(value)) {
    ...
    const staggerObserver = new IntersectionObserver(function (entries, observer) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          const baseDelay = parseInt(container.getAttribute('data-stagger') || '100', 10);
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '4114791e-e19b-49e4-98eb-3f8af4b50132',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '4114791e-e19b-49e4-98eb-3f8af4b50132';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4114791e-e19b-49e4-98eb-3f8af4b50132';
